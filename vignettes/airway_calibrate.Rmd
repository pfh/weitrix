---
title: "RNA-Seq components, airway dataset, using cpm+weitrix_calibrate_trend"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{airway_calibrate}
...
rowData(airway_cal) %>% as.data.frame() %>% 
    ...
    geom_point(aes(y=dispersion^0.25), size=0.1) +
...
BiocParallel::bpstop( DelayedArray::getAutoBPPARAM() )
```
