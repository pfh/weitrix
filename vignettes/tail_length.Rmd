...
Our weights were overoptimistic for large numbers of reads. There is a biological components of noise that does not go away with more reads. We use `comp_design` as a model while calibrating out the overdispersion due to biological noise. Note: the dispersion shown is *after taking into account weights*.
